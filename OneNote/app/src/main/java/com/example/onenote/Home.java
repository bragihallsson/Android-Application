...
public class Home extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.loction){
            Toast.makeText(this, "Testing Your Location", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this,PermissionsActivity.class);
            startActivity(i);
        }
        if(item.getItemId() == R.id.test){
            Toast.makeText(this, "Trying Notifications", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this,TryNotification.class);
            startActivity(i);
        }
